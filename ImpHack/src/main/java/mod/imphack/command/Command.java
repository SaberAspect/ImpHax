...
public abstract class Command extends CommandFeature {
    ...
    public static void sendMessage(final String message) {
        sendSilentMessage(Main.cmdManager.getClientMessage() + " " + ChatFormatting.GRAY + message);
    }
    ...
    public static String getCommandPrefix() {
        return Main.cmdManager.getPrefix();
    }
