...
public class ImpHackFontRenderer extends ImpHackFont {
	  protected CharData[] boldChars = new CharData[256];
	    ...
	    public ImpHackFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics) {
		...
		public float drawCenteredString(String text, float x, float y, ColorUtil color) {
