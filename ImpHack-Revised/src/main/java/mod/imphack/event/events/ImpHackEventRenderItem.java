...
public class ImpHackEventRenderItem extends ImpHackEventCancellable {
    double mainX, mainY, mainZ, offX, offY, offZ, mainRAngel, mainHandScaleX, mainHandScaleY, mainHandScaleZ, offHandScaleX, offHandScaleY, offHandScaleZ;


    public ImpHackEventRenderItem(double mainX, double mainY, double mainZ, double offX, double offY, double offZ, double mainRAngel,double mainHandScaleX, double mainHandScaleY, double mainHandScaleZ, double offHandScaleX, double offHandScaleY, double offHandScaleZ) {
        this.mainX = mainX;
        this.mainY = mainY;
        this.mainZ = mainZ;
        this.offX = offX;
